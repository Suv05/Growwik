    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-20 container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl font-bold mb-12 text-center">Strategy & Execution</h2>
      ...
      <section className="py-20 bg-zinc-900/50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold mb-6 text-center">Content Planning</h2>
            <Card className="p-6 bg-black/50 border-zinc-800">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-8">
              ...
              achieve similar results for your brand using innovative AI technologies.
            </p>
